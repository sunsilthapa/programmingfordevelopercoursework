...
public class ServiceCenters {
    ...
    public static void main(String[] args) {
        ...
        ServiceCenters que2b = new ServiceCenters();
        ...
        System.out.println("Minimum number of service centers : " + minCenters);
    }
}